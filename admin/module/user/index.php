        ...
        <div class="row">
            <div class="col-lg-12 main-chart">
                ...
                <div class="col-sm-3">
                    <div class="panel panel-primary">
                        ...
                        <div class="panel-footer">
                            <form method="POST" action="funsi/edit/edit.php?gambar=user" enctype="multipart/form-data">
                                    ...
                                    <fieldset>
                                        <div class="control-group">
                                            ...
                                            <div class="input-group">
                                                ...
                                                </div><input type="text" class="form-control" style="border-radius:0px;"
                                                    name="nama" data-items="4" value="<?php echo $hasil['nm_member'];?>"
                                                    required="required" />
                                            </div>
                                        </div>
                                        <div class="control-group"> <label class="control-label"
                                                for="typeahead">Email</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                    <i class="fa-envelope-square">
                                                    </i>
                                                </div>
                                        ...
                                        <div class="control-group"><label class="control-label" for="typeahead">
                                                Telepon</label>
                                            <div class="input-group">
                                                <div class="input-group-addon">
                                                ...
                                                <input type="text" class="form-control" style=" border: radius 0px;"
                                                    name="tlp" value="<?php echo $hasil['telepon']; ?>"
                                                    required="required" />
                                            </div>
                                        </div>
                                        <div class="control-group">
                ...
                <div class="col-sm-4">
                    <div class="panel panel-primary">
                        <div class="panel-heading">
                            <h4><i class="fa fa-lock"> Ganti Password</i></h4>
                        </div>
                        <div class="panel-body">
                            <div class="box-content">
                                        ...
                                        <div class="pull-right">
                                            ...
                                            <button type="submit" class="btn btn-primary" value="Tambah"
                                                style="border-radius:0px;" name="proses"> <i
                                                    class="fa fa-pencil"></i>Ubah Password<< /button>
                                        </div>
                                    </fieldset>
                                </form>
                            </div>
