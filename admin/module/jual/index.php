                                        ...
                                        <td>
                                            ...
                                            <form method="POST" action="function/edit.php?jual=jual">
                                                ...
                                                <input type="hidden" name="id_barang"
                                                    value="<?php echo $isi['is_barang']; ?>" class="form-control">
                                        </td>
                            ...
                            <div id="kasirnya">
                                    ...
                                    if (!empty($bayar)) {
                                        ...
                                        if ($bayar >= $total) {
                                            ...
                                            for ($x = 0; $x < $jumlah_dipilih; $X++) {
                                                ...
                                                $d = array(
                                                    $id_barang[$x], $id_member[$x],
                                                    $jumlah[$x], $total[$x], $tgl_input[$x], $periode[$x]
                                                );
                                ...
                                ?>
                                    ...
                                    <form method="POST" action="index.php?page=jual&nota=yes#kasirnya">
                                        ...
                                        <input type="hidden" name="periode[]" value="<?php echo $isi['m-Y'];?>">
                                        <?php $no++;  }?>
                                        <>
                                            <td>Total Semua </td>
                                        ...
                                        {?> <a class="btn btn-danger"
                                                    href="function/hapus/hapus.php?penjualan=jual"><b>RESET</b></a></td>
                                            <?php }?></td>
                                            </tr>
                                    </form>
                                    <!-- aksi ke table nota -->
                                    <tr>
                                        ...
                                        <td></td>
                                        <td>
                                            <a href="print.php?nm_member=<?php echo $_SESSION['admin']['nm_member'];?> &bayar=<?php echo $bayar;?>&kembali=<?php echo $hitung;?>"
                                                target="_blank"><button class="btn btn-default"><i
                                                        class="fa fa-print"></i>
                                                    Print Untuk Bukti Pembayaran</button></a>
                                        </td>
                                    </tr>
                                </table>
                                <br />
