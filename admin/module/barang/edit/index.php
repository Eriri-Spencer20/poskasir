        ...
        <div class="row">
            <div class="col-lg-12 main-chart">
                <a href="index.php?page=barang">
                    <button class="btn btn-primary"><i class="fa fa-angle-left"></i>Balik</button>
                </a>
                ...
                <table class="table table-striped">
                    <form action="function/edit/edit.php?barang=edit " method="POST">
                        <tr>
                            ...
                            <td>
                                <input type="text" readonly="readonly" class="form-control"
                                    value="<?php echo $hasil['id_barang'];?>" name="id">
                            </td>
                        </tr>
                        <tr>
                            <td>Kategori</td>
                            <td>
                                <select name="kategori" class="form-control">
                                    ...
                                    <option value="<?php echo $isi['id_kategori'];?>">
                                        <?php echo $isi['nama_kategori'];?></option> <?php }?>
                                </select>
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            ...
                            <td>
                                <select name="satuan" class="form-control">
                                    <option value="<?php echo $hasil['satuan_barang'];?>"></option>
                        ...
                        <tr>
                            <td></td>
                            <td>
                                <buton class="btn btn-primary"><i class="fa fa-edit"></i>Update Edit</buton>
                            </td>
                        </tr>
                    </form>
                </table>
