         ...
         <div class="row">
             <div class="col-lg-12 main-chart">
                 <h3>
                     ...
                     Data Laporan Penjualan <?= $bulan_tes[$_POST['bln']];?>
                     <?= $_POST['thn'];?>
                     <?php  }elseif(!empty($_GET['hari'])){?>
                     Data Laporan Penjualan <?= $_POST['hari'];?> <?php }else{?>
                 ...
                 <form method="post" action="index.php?page=laporan&cari=ok">
                     <table class="table table-striped">
                         ...
                         <tr>
                             <td>
                                 <select name="bln" class="from-control">
                                     <?php
                                 $bulan=array("Jaunari","Februari","Maret","April","Mei","Juni","Juli","Agustus","September","Oktober","November","Desember");
                                 $jlh_bln=count($bulan);
                                 $bln1 =array("01","02","03","04","05","06","07","08","09","10","11","12");
                                 $no=1;
                                 for ($c=0; $c<$jlh_bln; $c+=1) {
                                     echo"<option value='$bln1[$c]'> $bulan [$c]
                                     </option>";
                                 $no++;}
                                 ?>
                                 </select>
                             ...
                             <td>
                                 <?php
                             $now=date('Y');
                             echo "<select name='thn' class= 'from-control'>";
                             echo '
                             ...
                             <td>
                                 ...
                                 <a href="index.php?page=laporan" class="btn btn-success">
                                     <i class="fa fa-search"></i> Refresh</a>
                     ...
                     <table class="table table-striped">
                         ...
                         <tr>
                             ...
                             <td>
                                 ...
                                 <a href="index.php?page=laporan" class="btn btn-success"><i class="fa fa-refresh"></i>
                                     Refresh</a>

                                 <?php if(!empty($_GET['hari'])){?>
                                 <a href="excel.php?hari=cek$tgl=<?= $_POST['hari']?>" class="btn btn-info"><i
                                         class="fa fa-download">Excel</i></a>
                                 <?php }else{?>
                                 <a href="excel.php" class="btn btn-info"><i class="fa fa-download"></i>Excel</a>
                                 <?php }?>
                             </td>
                 ...
                 <div class="modal-view">
                     <table class="table table-bordered" id="exemple1">
                         <thead>
