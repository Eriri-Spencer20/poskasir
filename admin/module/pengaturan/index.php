                 ...
                 <table class="table table-stripped">
                     ...
                     <tbody>
                         <form method="post" action="function/edit/edit.php?pengaturan=ubah">
                             <tr>
                                 <td><input class="form-control" name="namatoko"
                                         value="<?php echo $toko['nama_toko'];?>" placeholder="Nama Toko"></td>
                                 <td><input class="form-control" name="alamat"
                                 ...
                                 <td><button id="tombol-simpan" class="btn btn-primary"><i class="fa fa-pencil"></i>
